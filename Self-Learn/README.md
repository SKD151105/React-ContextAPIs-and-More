...
This folder contains small React practice projects built while learning core concepts, component structure, state management, and reusable UI patterns.
...
- Each project has its own README with setup details and feature notes.
- These projects are kept separate so they can be practiced and extended independently.
